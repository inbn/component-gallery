...
The site’s CSS is generated using the utility-first framework, [Tailwind](https://tailwindcss.com/). Syntax highlighting uses [Prism](https://prismjs.com/). The fonts used are: [DM Sans](https://fonts.google.com/specimen/DM+Sans) for headings and navigation; and [Palatino](https://en.wikipedia.org/wiki/Palatino) for body text[^1].
